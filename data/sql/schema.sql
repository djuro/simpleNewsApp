CREATE TABLE articles (id INT AUTO_INCREMENT, title VARCHAR(180) NOT NULL, text TEXT NOT NULL, category_id INT NOT NULL, published_at DATETIME NOT NULL, read_count INT NOT NULL, user_id INT NOT NULL, published TINYINT NOT NULL, photo VARCHAR(60) NOT NULL, INDEX category_id_idx (category_id), INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE profiles (id INT, name VARCHAR(50) NOT NULL, surname VARCHAR(80) NOT NULL, nickname VARCHAR(20) NOT NULL, email VARCHAR(60) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE roles (id INT AUTO_INCREMENT, name VARCHAR(9) NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE tags (id INT AUTO_INCREMENT, text VARCHAR(255) NOT NULL, article_id INT NOT NULL, INDEX article_id_idx (article_id), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE users (id INT AUTO_INCREMENT, role_id INT NOT NULL, username VARCHAR(8) NOT NULL, password VARCHAR(90) NOT NULL, active TINYINT NOT NULL, INDEX role_id_idx (role_id), PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE tags ADD CONSTRAINT tags_article_id_articles_id FOREIGN KEY (article_id) REFERENCES articles(id);
