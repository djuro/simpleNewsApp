...
<div id="page">
			...
			<div class="post">
			<h2 class="title">
			  <a href="<?php echo url_for('home/article').'/id/'.$article['id']?>"><?php echo $article['title'];?></a>
			</h2>
			<div class="entry">
			  <!-- slika -->
			...
			<p class="meta"><a href="#"><?php echo $article->Categories->getName()?></a>&nbsp;&nbsp;&nbsp;
				...
				<a href="<?php echo url_for('home/article').'/id/'.$article->getId()?>" class="permalink"><?php echo __('Read more')?></a> </p>
           </div>
		<?php endforeach; ?>
