...
<div id="page">
      ...
      <p class="meta"><?php echo $article->Users->Profiles[0]->getName().'&nbsp;'; echo $article->Users->Profiles[0]->getSurname();?>,
			...
			foreach($article->Comments as $comment)
			       {
			        ...
			        echo '</div>';
					echo '<p style="font-size:10px;"><strong>'.$comment->getUsers()->Profiles[0]->getName().'&nbsp;'.
					     $comment->getUsers()->Profiles[0]->getSurname().'&nbsp;'.
